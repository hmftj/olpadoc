...
<div class="form-group">
	...
	<input type="name"  onkeypress="return /[a-z]/i.test(event.key)"  name="fname" class="form-control" value="<?php echo htmlentities($data['fullName']);?>" >
														</div>
...
<div class="form-group">
		...
		<input type="text"  onkeypress="return /[a-z]/i.test(event.key)" name="city" class="form-control" required="required"  value="<?php echo htmlentities($data['city']);?>" >
														</div>
